...
# Generated by qmake (2.01a) (Qt 4.5.0) on: ?? 7? 16 10:49:12 2016
# Project:  GateWay.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents mainwindow.h posix_qextserialport.h qextserialbase.h socketservice.h serialservice.h temp_humi_light.h motor.h relays.h touch.h smoke.h infray.h shake.h pwm.h ultra.h .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp posix_qextserialport.cpp qextserialbase.cpp socketservice.cpp serialservice.cpp temp_humi_light.cpp motor.cpp relays.cpp touch.cpp smoke.cpp infray.cpp shake.cpp pwm.cpp ultra.cpp .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/GateWay1.0.0/ && (cd `dirname .tmp/GateWay1.0.0` && $(TAR) GateWay1.0.0.tar GateWay1.0.0 && $(COMPRESS) GateWay1.0.0.tar) && $(MOVE) `dirname .tmp/GateWay1.0.0`/GateWay1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/GateWay1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_qextserialbase.cpp moc_socketservice.cpp moc_serialservice.cpp moc_temp_humi_light.cpp moc_motor.cpp moc_relays.cpp moc_touch.cpp moc_smoke.cpp moc_infray.cpp moc_shake.cpp moc_pwm.cpp moc_ultra.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_qextserialbase.cpp moc_socketservice.cpp moc_serialservice.cpp moc_temp_humi_light.cpp moc_motor.cpp moc_relays.cpp moc_touch.cpp moc_smoke.cpp moc_infray.cpp moc_shake.cpp moc_pwm.cpp moc_ultra.cpp
...
moc_temp_humi_light.cpp: temp_humi_light.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) temp_humi_light.h -o moc_temp_humi_light.cpp

moc_motor.cpp: motor.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) motor.h -o moc_motor.cpp

moc_relays.cpp: relays.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) relays.h -o moc_relays.cpp

moc_touch.cpp: touch.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) touch.h -o moc_touch.cpp

moc_smoke.cpp: smoke.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) smoke.h -o moc_smoke.cpp

moc_infray.cpp: infray.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) infray.h -o moc_infray.cpp

moc_shake.cpp: shake.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) shake.h -o moc_shake.cpp

moc_pwm.cpp: pwm.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) pwm.h -o moc_pwm.cpp

moc_ultra.cpp: ultra.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) ultra.h -o moc_ultra.cpp
...
moc_temp_humi_light.o: moc_temp_humi_light.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_temp_humi_light.o moc_temp_humi_light.cpp
...
moc_infray.o: moc_infray.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_infray.o moc_infray.cpp

moc_shake.o: moc_shake.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_shake.o moc_shake.cpp

moc_pwm.o: moc_pwm.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_pwm.o moc_pwm.cpp

moc_ultra.o: moc_ultra.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ultra.o moc_ultra.cpp
