...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Jul 16 18:54:24 2016
# Project:  GateWay.pro
# Template: app
...
moc_socketservice.cpp: socketservice.h
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/moc $(DEFINES) $(INCPATH) socketservice.h -o moc_socketservice.cpp
